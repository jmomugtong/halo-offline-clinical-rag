...
\begin{tabular}{lll}
\toprule
\textbf{Condition} & \textbf{Faithfulness-NLI $\\uparrow$} & \textbf{EM-F1 $\\uparrow$} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Comparison of Condition across Faithfulness-NLI $\\uparrow$, EM-F1 $\\uparrow$}
\label{tab:2}
\end{table}
...
\begin{tabular}{llll}
\toprule
\textbf{Condition} & \textbf{Regime} & \textbf{Faithfulness-NLI $\\uparrow$} & \textbf{EM-F1 $\\uparrow$} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Comparison of Condition across Regime, Faithfulness-NLI $\\uparrow$, EM-F1 $\\uparrow$}
\label{tab:3}
\end{table}
...
\begin{tabular}{lllll}
\toprule
\textbf{Comparison} & \textbf{Mean Diff} & \textbf{Std Diff} & \textbf{CI$_{9}$$_{5}$} & \textbf{Significant?} \\
\midrule
...
\caption{Comparison of Comparison across Mean Diff, Std Diff, CI$_{9}$$_{5}$, Significant?}
\label{tab:4}
\end{table}
...
\textbf{\cite{cormack2009reciprocal}} Cormack, G. V., Clarke, C. L. A., \& Buettcher, S. (2009). Reciprocal rank fusion outperforms Condorcet and individual rank learning methods. \textit{Proceedings of the 32nd International ACM SIGIR Conference on Research and Development in Information Retrieval}, 758--759.

\textbf{\cite{ecker2022psychological}} Ecker, U. K. H., Lewandowsky, S., Cook, J., Schmid, P., Fazio, L. K., Brashier, N., … Amazeen, M. A. (2022). The psychological drivers of misinformation belief and its resistance to correction. \textit{Nature Reviews Psychology}, 1(1), 13--29.

\textbf{\cite{es2023ragas}} Es, S., James, J., Espinosa-Anke, L., \& Schockaert, S. (2023). RAGAS: Automated evaluation of retrieval augmented generation. \textit{arXiv preprint arXiv:2309.1522}.

\textbf{\cite{feuerriegel2023generative}} Feuerriegel, S., Frauen, D., Melnychuk, V., Schweisthal, J., Hess, K., Curth, A., … van der Schaar, M. (2023). Causal machine learning for predicting treatment outcomes. \textit{Nature Medicine}, 30, 958--968.

\textbf{\cite{ji2023survey}} Ji, Z., Lee, N., Frieske, R., Yu, T., Su, D., Xu, Y., … Fung, P. (2023). Survey of hallucination in natural language generation. \textit{ACM Computing Surveys}, 55(12), 1--38.

\textbf{\cite{karpukhin2020dense}} Karpukhin, V., Oğuz, B., Min, S., Lewis, P., Wu, L., Edunov, S., … Yih, W.-T. (2020). Dense passage retrieval for open-domain question answering. \textit{Proceedings of EMNLP 2020}, 6769--6781.

\textbf{\cite{katoch2020review}} Katoch, S., Chauhan, S. S., \& Kumar, V. (2021). A review on genetic algorithm: Past, present, and future. \textit{Multimedia Tools and Applications}, 80(5), 8091--8126.

\textbf{\cite{labrak2024biomistral}} Labrak, Y., Bazoge, A., Morin, E., Gourraud, P.-A., Rouvier, M., \& Dufour, R. (2024). BioMistral: A collection of open-source pretrained large language models for medical domains. \textit{arXiv preprint arXiv:2402.1037}.

\textbf{\cite{lewis2020retrieval}} Lewis, P., Perez, E., Piktus, A., Petroni, F., Karpukhin, V., Goyal, N., … Kiela, D. (2020). Retrieval-augmented generation for knowledge-intensive NLP tasks. \textit{Advances in Neural Information Processing Systems}, 33, 9459--9474.

\textbf{\cite{liu2022pretrain}} Liu, N. F., Lin, K., Hewitt, J., Paranjape, A., Bevilacqua, M., Petroni, F., \& Liang, P. (2023). Lost in the middle: How language models use long contexts. \textit{Transactions of the Association for Computational Linguistics}, 12, 157--173.

\textbf{\cite{min2022rethinking}} Min, S., Lyu, X., Holtzman, A., Artetxe, M., Lewis, M., Hajishirzi, H., \& Zettlemoyer, L. (2022). Rethinking the role of demonstrations: What makes in-context learning work? \textit{Proceedings of EMNLP 2022}, 11048--11064.

\textbf{\cite{nogueira2019passage}} Nogueira, R., \& Cho, K. (2019). Passage re-ranking with BERT. \textit{arXiv preprint arXiv:1901.0409}.

\textbf{\cite{reimers2019sentence}} Reimers, N., \& Gurevych, I. (2019). Sentence-BERT: Sentence embeddings using Siamese BERT-networks. \textit{Proceedings of EMNLP-IJCNLP 2019}, 3982--3992.

\textbf{\cite{robertson2009probabilistic}} Robertson, S., \& Zaragoza, H. (2009). The probabilistic relevance framework: BM25 and beyond. \textit{Foundations and Trends in Information Retrieval}, 3(4), 333--389.

\textbf{\cite{singhal2023large}} Singhal, K., Azizi, S., Tu, T., Mahdavi, S. S., Wei, J., Chung, H. W., … Natarajan, V. (2023). Large language models encode clinical knowledge. \textit{Nature}, 620(7972), 172--180.

\textbf{\cite{thakur2021beir}} Thakur, N., Reimers, N., Rücklé, A., Srivastava, A., \& Gurevych, I. (2021). BEIR: A heterogeneous benchmark for zero-shot evaluation of information retrieval models. \textit{Proceedings of NeurIPS 2021 Datasets and Benchmarks Track}.

\textbf{\cite{tsatsaronis2015overview}} Tsatsaronis, G., Balikas, G., Malakasiotis, P., Partalas, I., Zschunke, M., Alvers, M. R., … Paliouras, G. (2015). An overview of the BioASQ large-scale biomedical semantic indexing and question answering competition. \textit{BMC Bioinformatics}, 16(1), 138.

\textbf{\cite{xiong2021approximate}} Xiong, L., Xiong, C., Li, Y., Tang, K.-F., Liu, J., Bennett, P. N., … Overwijk, A. (2021). Approximate nearest neighbor negative contrastive estimation for dense text retrieval. \textit{Proceedings of ICLR 2021}.
